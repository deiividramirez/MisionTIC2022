          ...
          while (true) {
               ...
               if(this.turnoActual == ParametroLogico.JUGADOR_O){
                    if(modo == ParametroLogico.MODO_MANUAL){
                         this.jugadorO.estategiaManual(tablero);;
                    }else{
                         this.jugadorO.estrategiaAleatoria(tablero);
                    }                
               }else{
                    if(modo == ParametroLogico.MODO_MANUAL){
                         this.jugadorX.estategiaManual(tablero);;
                    }else{
                         this.jugadorX.estrategiaAleatoria(tablero);  
                    }                
               }
